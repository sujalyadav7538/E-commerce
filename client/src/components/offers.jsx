...
export const Offers = () => {
  return (
    <div className="flex justify-center items-center p-3">
      <div className="bg-gradient-to-r from-pink-200 via-pink-100 to-pink-400 w-[80%] flex rounded-md p-6">
        <div className="gap-4 flex flex-col m-auto">
          ...
          <button className="bg-red-600 p-3 text-white text-xl rounded-2xl text-center">
            Check Now
          </button>
        </div>
        <div>
