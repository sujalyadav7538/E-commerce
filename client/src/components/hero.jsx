        ...
        <div className='flex flex-col flex-1 justify-center lg:px-60 '>
             ...
             <div className='m-0'>
                <div className='flex gap-5 items-center'>
                    <p className='lg:text-6xl font-semibold'>new</p>
                    <img src={hand_icon} alt="" className='h-[50px] w-[50px] lg:w-[100px] lg:h-[80px]'/>
                </div>
                <p className='text-lg lg:text-6xl font-semibold'>Collections</p>
                <p className='text-lg lg:text-6xl font-semibold'>for everyone</p>
             </div>
             <div className='flex w-[200px] my-6 gap-6 items-center bg-red-700 lg:w-[250px] p-3 text-white rounded-full cursor-pointer hover:bg-red-600 lg:my-10'>
                <div className='sm:text-lg  lg:text-xl font-normal'>Latest Collections</div>
